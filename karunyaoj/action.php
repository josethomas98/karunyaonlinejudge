...
if($sq)
{
    ...
    require_once('mail/class.phpmailer.php');
            ...
            $mail->Username = 'stinoin619@gmail.com';                 // SMTP username
            $mail->Password = 'jose(1998)';                           // SMTP password
            ...
            //$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
               ...
               $mail->setFrom('stinoin619@gmail.com', 'Karunya OJ');
