 ...
 <div class="row">
  ...
  <nav class="shadow navbar navbar-inverse navbar-fixed-top nbar">
    <div class="navbar-header">
      <a class="navbar-brand lspace" href="home.php">Karunya O J</a>
...
$q3="SELECT * FROM rapl_oj_contest ORDER BY date_on DESC LIMIT 0,2";  //query to select the contest
  ...
  while($row=mysqli_fetch_array($sq3))
    {
      ...
      $i++;   
      $demo="demo".$i;   
      $nr=mysqli_fetch_array($sq4); //ARRAY
      $nm=mysqli_fetch_array($sq5); //ARRAY
      $ns=mysqli_fetch_array($sq6); //ARRAY
...
<b></b><br>
<b>Karunya Institute of Technology nd Sciences</b>
